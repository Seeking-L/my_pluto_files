...
# ╔═╡ c0d46aad-6805-4d17-baee-cb91f659f787
using PlutoUI

# ╔═╡ 0cfc2db5-b653-4724-b14d-7b5e3784bf3a
using Plots

# ╔═╡ 43d214e7-6bf3-4cc9-a61f-154db9ee1093
using CoolProp

# ╔═╡ 0807d38f-e97a-41c7-b27d-3b892860ec52
md"""
等熵线  $(@bind const_s CheckBox())
等焓线  $(@bind const_h CheckBox())
等温线  $(@bind const_t CheckBox())
"""

# ╔═╡ 2a927ece-365f-4fe9-b72f-511d5fa04b47
if const_s
md"""熵： $(@bind s Slider(1:0.1:10)) kJ/(kg℃)"""
end

# ╔═╡ 10e66935-d2cb-4f21-83fe-01e10a02c7a3
if const_h
md"""焓： $(@bind h Slider(500:10:5000)) kJ/kg"""
end

# ╔═╡ 97022287-3c9e-4469-b3e7-a95e50167371
if const_t
md"""温度： $(@bind t Slider(273.06+50:0.1:647.096)) ℃"""
end

# ╔═╡ b0ec22f9-4e82-45f2-80cf-b245342ab822
v=0.01:0.0001:10

# ╔═╡ b737cc8c-227e-4c78-82c9-b2631109f457
y=PropsSI.("P", "T", 410, "S", 400, "Water")
